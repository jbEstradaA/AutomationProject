...
public class ContactUsPage extends ParentPage {
    ...
    /**
     * This method is to do click on the SelectControl of subject type
     */
    ...
    public void selectSubjectType(String Subject) {
        sendKeysToElement(Select_subject, Subject + Keys.ENTER);
    }
    ...
    public String getSubjectDescription() {
        String TextValue;
        TextValue = getTextFromElement(Span_subject);
        switch (TextValue){
